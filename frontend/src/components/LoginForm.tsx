          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 font-semibold text-xl">
              ...
              <button
                ...
                className="text-indigo-600 hover:text-purple-700 font-semibold underline"
              >
                Sign Up
              </button>
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 bg-violet-50 outline-none"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover:from-indigo-700 transition disabled:opacity-50 flex items-center justify-center gap-2"
            >
